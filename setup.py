...
setup(
    name='Webscraping-ASN',
    version='1.0.0',
    packages=['venv.Lib.site-packages.bs4', 'venv.Lib.site-packages.bs4.builder', 'venv.Lib.site-packages.lxml',
              'venv.Lib.site-packages.lxml.html', 'venv.Lib.site-packages.lxml.includes',
              'venv.Lib.site-packages.lxml.includes.libxml', 'venv.Lib.site-packages.lxml.includes.extlibs',
              'venv.Lib.site-packages.lxml.includes.libxslt', 'venv.Lib.site-packages.lxml.includes.libexslt',
              'venv.Lib.site-packages.lxml.isoschematron', 'venv.Lib.site-packages.tqdm',
              'venv.Lib.site-packages.tqdm.contrib', 'venv.Lib.site-packages.cchardet',
              'venv.Lib.site-packages.colorama', 'venv.Lib.site-packages.soupsieve',
    ...
    url='https://github.com/mhosman89/Webscraping-ASN',
    license='',
    author='Mohamed Osman',
    author_email='mhosmanit@outlook.com',
